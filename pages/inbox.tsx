...
export default function InboxPage() {
  ...
  const conversations: Conversation[] = [
    ...
    {
      id: '4',
      subject: 'Sales Ticket - Nieuwe aanvraag',
      customer: { name: 'Lisa Bakker', email: 'l.bakker@company.nl' },
      channel: 'sales_ticket',
      status: 'new',
      priority: 'medium',
      lastMessage: 'Interesse in laadstation voor bedrijfspand',
      lastMessageTime: '08:45',
      unreadCount: 1,
      businessEntityId: 'zaptecshop',
      orderId: 'ZS-2024-012'
    }
  ];
  ...
  return (
    <AppLayout>
      <div className="h-full flex bg-background">
        {/* Left Sidebar - Folder Structure (320px) */}
        ...
        {/* Middle Left - Conversation List (384px) */}
        ...
        {/* Middle Right - Chat View (Flexible) */}
        ...
        {/* Right Sidebar - Contact/Order Info (320px) */}
